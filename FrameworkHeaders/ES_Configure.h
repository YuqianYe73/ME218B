...
#define SERV_0_HEADER "StepperService.h"
// the name of the Init function
#define SERV_0_INIT InitStepperService
// the name of the run function
#define SERV_0_RUN RunStepperService
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "StepperServicePWM.h"
// the name of the Init function
#define SERV_1_INIT InitStepperServicePWM
// the name of the run function
#define SERV_1_RUN RunStepperServicePWM
// How big should this services Queue be?
...
#define TIMER0_RESP_FUNC PostStepperService
#define TIMER1_RESP_FUNC PostStepperServicePWM
